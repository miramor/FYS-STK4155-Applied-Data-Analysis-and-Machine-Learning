...
make_confusion_matrix(y_test, y_pred, fn="cm_heatmap_logreg_own.pdf", title = "Logistic Regression")
make_confusion_matrix(y_test, pred_sklearn, fn="cm_heatmap_logreg_sklearn.pdf", title = "Logistic Regression SKlearn")
